...
def test_dashboard_displaying(dashboard_page_with_state: DashboardPage):
    ...
    dashboard_page_with_state.check_visible_student_title()
    dashboard_page_with_state.check_visible_activities_title()
    dashboard_page_with_state.check_visible_scores_title()
    dashboard_page_with_state.check_visible_courses_title()
